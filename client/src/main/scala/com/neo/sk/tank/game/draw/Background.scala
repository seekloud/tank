...
trait Background{ this:GameContainerClientImpl =>
  ...
  private val goldImg = new Image(s"/tank/static/img/金牌.png")
  private val silverImg = new Image(s"/tank/static/img/银牌.png")
  private val bronzeImg = new Image(s"/tank/static/img/铜牌.png")
